...
const db_table_event_demo_vi = require('../public/javascripts/dao/db_table_event_demo_vi');
const db_table_event_demo_en = require('../public/javascripts/dao/db_table_event_demo_en');
/**
 * Get home page
 */
router.get('/event/:id', function (req, res, next) {
    try {
        ...
        let tableshow = db_table_event_demo_vi;
        req.session.CUR_URl = '/events-details/event' + id;
        let link = req.session.CUR_URl;
        if (lang == null || lang == '' || lang == "") {
            ...
            tableshow = db_table_event_demo_en;
        }
        req.session.lang = lang;
        req.session.CUR_URl = '/events-details/' + id;
        ...
        let info_total_home_page = [title, logo_name, link];
        ...
        tableshow.findOne({
            ...
            tableshow.findAll(
                ...
                res.render(page_common.page_detail, { info_total_home_page: info_total_home_page, menu_data: menu_data, lang_session: lang, info: result, gallery_details: gallery_details, controller: 'events-details/event' });
            });
        })
    } catch (e) {

    ...
    xhttp.onreadystatechange = function () {
        if (xhttp.readyState == 4 && xhttp.status == 200) {
            ...
            for (var i = 0; i < data_events.length; i++) {
                str += "<li><a href='/events-details/event/" + data_events[i].id + "'> <div class='media'> <div class='media-left'> <a href='/events-details/event/" + data_events[i].id + "'> <img class='media-object' src='/stylesheets/assets/img/menu/" + data_events[i]['path_img'] + "' alt='img'> </a> </div> <div class='media-body' style=' white-space: nowrap; overflow: hidden; text-overflow: ellipsis; '> <h4 class='media-heading'> <a href='/events-details/event/" + data_events[i].id + "'> <b>" + data_events[i]['title'] + "</b> </a> </h4> <span class='mu-menu-price'>" + numberWithCommas(data_events[i]['price']) + " VND</span> <p>" + data_events[i]['description'] + " (" + data_events[i]['fullName'] + ")</p> </div> </div> </a> </li>";
            }
